   // $(document).on('click','#loadTree',function(e) {
   //    init();
   // })

   function init(users,first) {
    // alert(users);
   ...
   // }
      ...
      function textStyle() {
       return { font: "9pt  Segoe UI,sans-serif", stroke: "#454d55" };
     }
     ...
     // }
      ...
      $(go.Node, "Auto",
        // { doubleClick: nodeDoubleClick },
          ...
          $(go.Shape, "Rectangle",
          {
           name: "SHAPE", fill: "#fff", stroke: 'white', strokeWidth: 1,
          ...
          $(go.Panel, "Horizontal",
           ...
           // new go.Binding("source", "key", findHeadShot)),
            ...
            $(go.RowColumnDefinition, { column: 2, width: 4 }),
             $(go.Picture, "profile_image",
              { column: 4, width: 60, height: 60, margin: 5,
              imageStretch: go.GraphObject.Fill },
             new go.Binding("source", "profile_image").makeTwoWay()),
             ...
             new go.Binding("text", "sale_right",function(sr){
              ...
              // $(go.TextBlock, textStyle(),
              //    { row: 2, column: 0 },
              //    new go.Binding("text", "user_type", function(v) { return (v == 'virtual') ? "( " + v+")" : ''; })),
              // $(go.TextBlock, textStyle(),
      ...
      $(go.Link, go.Link.Orthogonal,
        { corner: 5, relinkableFrom: true, relinkableTo: true },
          $(go.Shape, { strokeWidth: 3, stroke: "#ccc" }));  // the link shape
