                                        ...
                                        <tr>
                                          <td>
                                            <table align="center" cellpadding="0" cellspacing="0" border="0" width="500">
                                              <tr>
                                                <td class="size-20" align="center" style="font-weight:600; font-size:28px; color:black; font-family:Helvetica; mso-line-height-rule: exactly; text-align:center; line-height:42px;">DefiXFinance NFT Withdrawal Verification</td>
                                              </tr>
                                              <tr>
                                                ...
                                                A NFT withdrawal request has been made on your account. If you want to continue, please click the link below. If it is not you, please login your account and change your password immediately</td>
                                              </tr>
                                              <tr>
                                                <td class="pad-B20" align="center" style="font-weight:bold; font-size:16px; color:black; font-family:Helvetica; mso-line-height-rule: exactly; line-height:26px; padding:10px 0px 10px;">
                                                  ...
                                                  <a href="{{$routeUrl}}">I confirm my request to withdraw NFT</a>
                                                </td>
                                              </tr>
