...
@section('content')
                            ...
                            <div>
                                <div class="bg-card-{{ $i }} text-center p-4 pb-3 rounded mx-2 position-relative">
                                    ...
                                    @if ($stakingpool->investedAmount > 0)
                                        ...
                                        <a class="btn bg-white text-warning px-3 rounded-0 font-10 mt-2 card-4-btn"
                                            href="{{ route('stakepool', $stakingpool->id) }}">{{ __('custom.stake') }}
                                            <img src="{{ asset('assets/images/assets/Dashboard/Group930.png') }}"
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="card bg-crypto-wallet">
                            <div class="card-body text-white">
                                ...
                                <p class="fs-30 mb-2">
                                    ${{ $user->userwallet ? number_format($user->userwallet->crypto_wallet, 2) : '' }}
                                </p>
                                            ...
                                            <div class="col-12 col-xl-7">
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <p class="font-12"><a class="text-decoration-none text-dark"
                                                            href="{{ route('news-and-events.show', $value->id) }}">{!! \Illuminate\Support\Str::limit($value->details, 100) !!}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        @else
                                            ...
                                            <div class="d-flex align-items-center {{ $key > 1 ? 'mt-3' : '' }}">
                                                <div>
                                                    <a href="{{ route('news-and-events.show', $value->id) }}"><img
                                                            src="{{ $value->image }}" class="img-fluid"
                                                            alt=""></a>
                                                </div>
                                                <div class="ml-3 border-bottom pb-3">
                                                    ...
                                                    <h5 class="font-weight-bold"><a class="text-dark text-decoration-none"
                                                            href="{{ route('news-and-events.show', $value->id) }}">{!! \Illuminate\Support\Str::limit($value->details, 50) !!}</a>
                                                    </h5>
                                                </div>
                                            </div>
    ...
    @if ($user->userwallet['crypto_wallet'] == 0 && $user->staking_history->count() == 0)
        <div class="modal fade bs-example-modal-center custom-model" tabindex="-1" role="dialog"
            aria-labelledby="points-alert" aria-hidden="true" style="display: none;" id="points_alert">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-warning text-white">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0"><span class="mdi mdi-alert"></span> {{ trans('custom.notice') }}
                        </h5>
                    </div>
    ...
    @if ($user->userwallet['crypto_wallet'] > 0 && $user->staking_history->count() == 0)
        ...
        <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="points-alert"
            aria-hidden="true" style="display: none;" id="points_alert">
                ...
                <div class="modal-content bg-warning text-white">
                    ...
                    <div class="modal-body">
                        <div class="font-16">
                            ...
                            <a href="{{ route('stacks') }}"
                                class="mtext-cred">{{ trans('custom.click_here_add_package') }}</a>
                        </div>
