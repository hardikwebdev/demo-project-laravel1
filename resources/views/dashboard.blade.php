            ...
            <div class="card-body p-4">
              <div class="row pt-2">
                ...
                <div class="col-12 col-md-6 text-md-right">
                  <select name="grphfilter" class="rounded-0 font-weight-bold border-violate font-12 p-2 px-3 grphfilter">
                    <option value="{{\Carbon\Carbon::now()->format('m')}}">{{ __('custom.this_month') }}</option>
                    <option value="{{\Carbon\Carbon::now()->subMonth()->format('m')}}">{{ __('custom.last_month') }}</option>
                ...
                <div class="col-12 col-md-4 text-center mt-3">
                  <p class="d-flex align-items-center justify-content-center mb-0 text-grey"><span
                    ...
                    <h4 class="text-black font-weight-bold mt-2"><span id="apr_monthly">
                      ${{ number_format($commissionData[\Carbon\Carbon::now()->format('m')]['apr_monthly'][1], 2) }}</span></h4>
                    </div>
                    <div class="col-12 col-md-4 text-center mt-3">
                      <p class="d-flex align-items-center justify-content-center mb-0 text-grey"><span
                    ...
                    <div class="col-12 col-md-4 text-center mt-3">
                      ...
                      <h4 class="text-black font-weight-bold mt-2">
                        <span id="balancing_commission">${{ number_format($commissionData[\Carbon\Carbon::now()->format('m')]['balancing_commission'][1], 2) }}</span>
                      </h4>
                    </div>
                  </div>
                </div>
