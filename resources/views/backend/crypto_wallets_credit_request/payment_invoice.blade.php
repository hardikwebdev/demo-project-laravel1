...
<body style="background-image: url({{ asset('assets/receipt/defix-cert-background.jpg') }}); -webkit-background-size:100%; -moz-background-size:100%; -o-background-size:100%; background-size:100%; background-position:center; background-repeat:no-repeat; padding-top: 50px;">
          ...
          <tr>
            <td align="center" style="padding:45px 0px;">
              <a style="text-decoration:none; outline:none;" href="#" title="Vextrader">
                <img src="{{ asset('assets/receipt/defix-logo-white.png') }}" width="350" style="display:block;" />
              </a>
            </td>
          </tr>
        </table>
