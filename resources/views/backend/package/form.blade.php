        ...
        <div class="col-sm-6 pl-0 ">
            <div class="form-group">
                <label>Staking Period (12 Month) Start</label> 
                 {!! Form::number('staking_actual12_start',old('staking_actual12_start'),['class'=>'form-control','placeholder'=>'Enter Staking Period (12 Month) Start','min'=>'0']) !!}
        ...
        <div class="col-sm-6 pl-0 ">
            <div class="form-group">
                <label>Staking Period (12 Month) End</label> 
                 {!! Form::number('staking_actual12_end',old('staking_actual12_end'),['class'=>'form-control','placeholder'=>'Enter Staking Period (12 Month) End','min'=>'0', 'id' => 'staking_actual12_end']) !!}
        ...
        <div class="col-sm-6 pl-0 ">
            <div class="form-group">
                <label>Staking Period (24 Month) Start</label> 
                 {!! Form::number('staking_actual24_start',old('staking_actual24_start'),['class'=>'form-control','placeholder'=>'Enter Staking Period (24 Month) Start','min'=>'0']) !!}
        ...
        <div class="col-sm-6 pl-0 ">
            <div class="form-group">
                <label>Staking Period (24 Month) End</label> 
                 {!! Form::number('staking_actual24_end',old('staking_actual24_end'),['class'=>'form-control','placeholder'=>'Enter Staking Period (24 Month) End','min'=>'0']) !!}
