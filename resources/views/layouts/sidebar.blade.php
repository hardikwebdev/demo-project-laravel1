 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item {{ (Route::currentRouteName() == 'node_register' || Route::currentRouteName() == 'node_management') ? 'active' : '' }}">
      ...
      <div class="collapse" id="node">
        <ul class="nav flex-column sub-menu rounded-bottom">
          <li class="nav-item {{ (Route::currentRouteName() == 'node_register') ? 'active' : '' }}"> 
            <a class="nav-link pl-0" href="{{ route('node_register') }}">{{trans('custom.register')}}</a>
          </li>
          @if(auth()->user()->staking_history->count() > 0 ) 
          <li class="nav-item {{ (Route::currentRouteName() == 'node_management') ? 'active' : '' }}"> 
    ...
    <li class="nav-item {{ (Route::currentRouteName() == 'crypto_wallets' || Route::currentRouteName() == 'yield_wallet' || Route::currentRouteName() == 'commission_wallet' || Route::currentRouteName() == 'nft_wallet') ? 'active' : '' }}">
      ...
      <div class="collapse" id="wallets">
        <ul class="nav flex-column sub-menu rounded-bottom">
          <li class="nav-item {{ (Route::currentRouteName() == 'crypto_wallets') ? 'active' : '' }}"> 
            <a class="nav-link pl-0" href="{{ route('crypto_wallets') }}">{{trans('custom.crypto_wallet')}}</a>
          </li>
          @if(auth()->user()->staking_history->count() > 0 ) 
          <li class="nav-item {{ (Route::currentRouteName() == 'yield_wallet') ? 'active' : '' }}"> 
            <a class="nav-link pl-0" href="{{ route('yield_wallet') }}">{{trans('custom.yield_wallet')}}</a>
          </li>
          <li class="nav-item {{ (Route::currentRouteName() == 'commission_wallet') ? 'active' : '' }}"> 
            <a class="nav-link pl-0" href="{{ route('commission_wallet') }}">{{trans('custom.commission-wallet')}}</a>
          </li>
          <li class="nav-item {{ (Route::currentRouteName() == 'nft_wallet') ? 'active' : '' }}"> 
   ...
   <!--  <li class="nav-item {{ (Route::currentRouteName() == 'dashboard') ? 'active' : '' }}">
    ...
    @if(auth()->user()->staking_history->count() > 0 ) 
    <li class="nav-item {{ (Route::currentRouteName() == 'withdrawal') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ (Route::currentRouteName() == 'ledger') ? 'active' : '' }}">
    ...
    @if(auth()->user()->staking_history->count() > 0 ) 
    <li class="nav-item {{ (Route::currentRouteName() == 'news-and-events.index') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ (Route::currentRouteName() == 'help_support.index') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ (Route::currentRouteName() == 'helpandfaq') ? 'active' : '' }}">
