        ...
        <ul class="nav metismenu" id="side-menu">          
            ...
            <li class=" @if(\Request::is('admin-defix-portal/user') || \Request::is('admin-defix-portal/user/*') || strstr(\Request::route()->getName(),'proof_request') || strstr(\Request::route()->getName(),'package_history') ||  strstr(\Request::route()->getName(),'payment_history') || strstr(\Request::route()->getName(),'support_ticket') || strstr(\Request::route()->getName(),'ticket_request')) {{'active'}} @endif">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-defix-portal/user') || \Request::is('admin-defix-portal/user/*')) {{'active'}} @endif">
            ...
            <li class=" @if(\Request::is('admin-defix-portal/admin_fund_wallet') || \Request::is('admin-defix-portal/withdrawal_request') || \Request::is('admin-defix-portal/withdrawal_request/*') || \Request::is('admin-defix-portal/mt4-wallet-withdrawl-requests') || \Request::route()->getName() =='admin_pips_rebate.index' || \Request::route()->getName()=='admin_pips_rebate.import' || strstr(\Request::route()->getName(),'profit_sharing') || strstr(\Request::route()->getName(),'nft_withdrawal_request.index')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-defix-portal/crypto_wallets_credit_request')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-defix-portal/nft_wallets_credit_request')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-defix-portal/nft_purchase_request')) {{'active'}} @endif">
                   ...
                   <!--  <li class=" @if(\Request::is('admin-defix-portal/nft_on_sale_request')) {{'active'}} @endif">
                    ...
                    {{-- <li class=" @if(\Request::is('admin-defix-portal/withdrawal_request') || \Request::is('admin-defix-portal/withdrawal_request/*')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-defix-portal/withdrawal_request') || \Request::is('admin-defix-portal/withdrawal_request/*')) {{'active'}} @endif">
                      ...
                      <li class=" @if(\Request::is('admin-defix-portal/nft_withdrawal_request') || \Request::is('admin-defix-portal/nft_withdrawal_request/*')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-defix-portal/yield_wallet') || \Request::is('admin-defix-portal/yield_wallet/*')) {{'active'}} @endif">
                        <a href="{{route('yield_wallet.index')}}" title="Yield Wallet"> <span class="cus-sub-menu">Yield Wallet</span></a>
                    </li>
                    {{-- @role('admin')
                    <li class=" @if(\Request::is('admin-defix-portal/mt4-wallet-withdrawl-requests')) {{'active'}} @endif">
            ...
            <li class="@if(\Request::is('admin-defix-portal/packages') || \Request::is('admin-defix-portal/packages/*') || \Request::is('admin-defix-portal/pool-packages') || \Request::is('admin-defix-portal/pool-packages/*')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class="@if(\Request::is('admin-defix-portal/pool-packages') || \Request::is('admin-defix-portal/pool-packages/*')) {{'active'}} @endif">
                    ...
                    <li class="@if(\Request::is('admin-defix-portal/packages') || \Request::is('admin-defix-portal/packages/*')) {{'active'}} @endif">
                        <a href="{{ route('packages.index')}}" title=""> <span class="cus-sub-menu">Packages</span></a>
                    </li>
                </ul>
            </li>
            <li class="@if(\Request::is('admin-defix-portal/nft-category') || \Request::is('admin-defix-portal/nft-category/*') || \Request::is('admin-defix-portal/nft-product') || \Request::is('admin-defix-portal/nft-product/*')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class="@if(\Request::is('admin-defix-portal/nft-category') || \Request::is('admin-defix-portal/nft-category/*')) {{'active'}} @endif">
                    ...
                    <li class="@if(\Request::is('admin-defix-portal/nft-product') || \Request::is('admin-defix-portal/nft-product/*')) {{'active'}} @endif">
                        <a href="{{ route('nft-product.index') }}" title="Products"> <span class="cus-sub-menu">Products</span></a>
                    </li>
                </ul>
            </li>
            <li class=" @if(\Request::is('admin-defix-portal/package_setting') || \Request::is('admin-defix-portal/rank_setting')|| \Request::is('admin-defix-portal/setting') || \Request::is('admin-defix-portal/package_setting/*') || \Request::is('admin-defix-portal/rank_setting/*')|| \Request::is('admin-defix-portal/general_setting/*') || strstr(\Request::route()->getName(),'investment-plans')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-defix-portal/setting')) {{'active'}} @endif"><a href="{{route('setting.index')}}"><span class="cus-sub-menu">General Setting</span></a></li>
                    ...
                    {{-- <li class=" @if(\Request::is('admin-defix-portal/package_setting') || \Request::is('admin-defix-portal/package_setting/*')) {{'active'}} @endif"><a href="{{route('package_setting.index')}}"><span class="cus-sub-menu">Package Setting</span></a></li> --}}
                    {{-- <li class=" @if(\Request::is('admin-defix-portal/rank_setting')|| \Request::is('admin-defix-portal/rank_setting/*')) {{'active'}} @endif"><a href="{{route('rank_setting.index')}}"><span class="cus-sub-menu">Rank Setting</span></a></li> --}}
                    {{-- <li class=" @if(\Request::is('admin-defix-portal/investment-plans')|| \Request::is('admin-defix-portal/investment-plans/*')) {{'active'}} @endif"><a href="{{route('investment-plans.index')}}"><span class="cus-sub-menu">Investment Plans</span></a></li> --}}
                </ul>
            </li>
            <li class="@if(\Request::is('admin-defix-portal/news') || \Request::is('admin-defix-portal/news/*') || \Request::is('admin-defix-portal/announcement') || \Request::is('admin-defix-portal/announcement/*') || \Request::is('admin-defix-portal/slider') || \Request::is('admin-defix-portal/slider/*') ||   \Request::is('admin-defix-portal/ticket') ||   \Request::is('admin-defix-portal/ticket/*') ||   \Request::is('admin-defix-portal/product') ||   \Request::is('admin-defix-portal/product/*') ) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-defix-portal/news') || \Request::is('admin-defix-portal/news/*')) {{'active'}} @endif">
                        <a href="{{route('news.index')}}"><span class="cus-sub-menu"> News</span></a>               
                    </li>
                    {{-- <li class=" @if( \Request::is('admin-defix-portal/announcement') || \Request::is('admin-defix-portal/announcement/*')) {{'active'}} @endif">
                        <a href="{{route('announcement.index')}}"><span class="cus-sub-menu"> Announcement</span></a>               
                    </li>     --}}
                     <li class=" @if( \Request::is('admin-defix-portal/slider') || \Request::is('admin-defix-portal/slider/*')) {{'active'}} @endif">
