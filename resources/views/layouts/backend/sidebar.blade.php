        ...
        <ul class="nav metismenu" id="side-menu">          
            ...
            <li class=" @if(\Request::is('admin-demo-portal/user') || \Request::is('admin-demo-portal/user/*') || strstr(\Request::route()->getName(),'proof_request') || strstr(\Request::route()->getName(),'package_history') ||  strstr(\Request::route()->getName(),'payment_history') || strstr(\Request::route()->getName(),'support_ticket') || strstr(\Request::route()->getName(),'ticket_request')) {{'active'}} @endif">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-demo-portal/user') || \Request::is('admin-demo-portal/user/*')) {{'active'}} @endif">
            ...
            <li class=" @if(\Request::is('admin-demo-portal/admin_fund_wallet') || \Request::is('admin-demo-portal/withdrawal_request') || \Request::is('admin-demo-portal/withdrawal_request/*') || \Request::is('admin-demo-portal/mt4-wallet-withdrawl-requests') || \Request::route()->getName() =='admin_pips_rebate.index' || \Request::route()->getName()=='admin_pips_rebate.import' || strstr(\Request::route()->getName(),'profit_sharing') || strstr(\Request::route()->getName(),'nft_withdrawal_request.index')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-demo-portal/crypto_wallets_credit_request')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-demo-portal/nft_wallets_credit_request')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-demo-portal/nft_purchase_request')) {{'active'}} @endif">
                   ...
                   <!--  <li class=" @if(\Request::is('admin-demo-portal/nft_on_sale_request')) {{'active'}} @endif">
                    ...
                    {{-- <li class=" @if(\Request::is('admin-demo-portal/withdrawal_request') || \Request::is('admin-demo-portal/withdrawal_request/*')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-demo-portal/withdrawal_request') || \Request::is('admin-demo-portal/withdrawal_request/*')) {{'active'}} @endif">
                      ...
                      <li class=" @if(\Request::is('admin-demo-portal/nft_withdrawal_request') || \Request::is('admin-demo-portal/nft_withdrawal_request/*')) {{'active'}} @endif">
                    ...
                    <li class=" @if(\Request::is('admin-demo-portal/yield_wallet') || \Request::is('admin-demo-portal/yield_wallet/*')) {{'active'}} @endif">
                        <a href="{{route('yield_wallet.index')}}" title="Yield Wallet"> <span class="cus-sub-menu">Yield Wallet</span></a>
                    </li>
                    {{-- @role('admin')
                    <li class=" @if(\Request::is('admin-demo-portal/mt4-wallet-withdrawl-requests')) {{'active'}} @endif">
            ...
            <li class="@if(\Request::is('admin-demo-portal/packages') || \Request::is('admin-demo-portal/packages/*') || \Request::is('admin-demo-portal/pool-packages') || \Request::is('admin-demo-portal/pool-packages/*')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class="@if(\Request::is('admin-demo-portal/pool-packages') || \Request::is('admin-demo-portal/pool-packages/*')) {{'active'}} @endif">
                    ...
                    <li class="@if(\Request::is('admin-demo-portal/packages') || \Request::is('admin-demo-portal/packages/*')) {{'active'}} @endif">
                        <a href="{{ route('packages.index')}}" title=""> <span class="cus-sub-menu">Packages</span></a>
                    </li>
                </ul>
            </li>
            <li class="@if(\Request::is('admin-demo-portal/nft-category') || \Request::is('admin-demo-portal/nft-category/*') || \Request::is('admin-demo-portal/nft-product') || \Request::is('admin-demo-portal/nft-product/*')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class="@if(\Request::is('admin-demo-portal/nft-category') || \Request::is('admin-demo-portal/nft-category/*')) {{'active'}} @endif">
                    ...
                    <li class="@if(\Request::is('admin-demo-portal/nft-product') || \Request::is('admin-demo-portal/nft-product/*')) {{'active'}} @endif">
                        <a href="{{ route('nft-product.index') }}" title="Products"> <span class="cus-sub-menu">Products</span></a>
                    </li>
                </ul>
            </li>
            <li class=" @if(\Request::is('admin-demo-portal/package_setting') || \Request::is('admin-demo-portal/rank_setting')|| \Request::is('admin-demo-portal/setting') || \Request::is('admin-demo-portal/package_setting/*') || \Request::is('admin-demo-portal/rank_setting/*')|| \Request::is('admin-demo-portal/general_setting/*') || strstr(\Request::route()->getName(),'investment-plans')) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-demo-portal/setting')) {{'active'}} @endif"><a href="{{route('setting.index')}}"><span class="cus-sub-menu">General Setting</span></a></li>
                    ...
                    {{-- <li class=" @if(\Request::is('admin-demo-portal/package_setting') || \Request::is('admin-demo-portal/package_setting/*')) {{'active'}} @endif"><a href="{{route('package_setting.index')}}"><span class="cus-sub-menu">Package Setting</span></a></li> --}}
                    {{-- <li class=" @if(\Request::is('admin-demo-portal/rank_setting')|| \Request::is('admin-demo-portal/rank_setting/*')) {{'active'}} @endif"><a href="{{route('rank_setting.index')}}"><span class="cus-sub-menu">Rank Setting</span></a></li> --}}
                    {{-- <li class=" @if(\Request::is('admin-demo-portal/investment-plans')|| \Request::is('admin-demo-portal/investment-plans/*')) {{'active'}} @endif"><a href="{{route('investment-plans.index')}}"><span class="cus-sub-menu">Investment Plans</span></a></li> --}}
                </ul>
            </li>
            <li class="@if(\Request::is('admin-demo-portal/news') || \Request::is('admin-demo-portal/news/*') || \Request::is('admin-demo-portal/announcement') || \Request::is('admin-demo-portal/announcement/*') || \Request::is('admin-demo-portal/slider') || \Request::is('admin-demo-portal/slider/*') ||   \Request::is('admin-demo-portal/ticket') ||   \Request::is('admin-demo-portal/ticket/*') ||   \Request::is('admin-demo-portal/product') ||   \Request::is('admin-demo-portal/product/*') ) {{'active'}} @endif">
                <a href="#">
                ...
                <ul class="nav nav-second-level collapse" style="">
                    <li class=" @if(\Request::is('admin-demo-portal/news') || \Request::is('admin-demo-portal/news/*')) {{'active'}} @endif">
                        <a href="{{route('news.index')}}"><span class="cus-sub-menu"> News</span></a>               
                    </li>
                    {{-- <li class=" @if( \Request::is('admin-demo-portal/announcement') || \Request::is('admin-demo-portal/announcement/*')) {{'active'}} @endif">
                        <a href="{{route('announcement.index')}}"><span class="cus-sub-menu"> Announcement</span></a>               
                    </li>     --}}
                     <li class=" @if( \Request::is('admin-demo-portal/slider') || \Request::is('admin-demo-portal/slider/*')) {{'active'}} @endif">
