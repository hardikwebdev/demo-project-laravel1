                ...
                <div class="tab-content border-0">
                    <div id="home" class="tab-pane active">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-xl-auto ml-lg-auto mt-3 text-center">
                                <a href="#" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="staking_pool_filter">{{trans('custom.Filter')}}</a>
                                <a href="#" onclick="resetFormStakingPool()" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="staking_pool_filter">{{trans('custom.Clear')}}</a>

                                <button class="btn bg-warning text-white py-3 px-4 rounded-sm">{{trans('custom.EXPORT')}} <img
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-4 col-xl-auto mt-3">
                                <label style="display:none" id="datepicker1-error" class="error" for="datepicker1">{{trans('custom.start_date_must_be_less_then_end_date')}}</label>
                            </div>
                            <div class="col-12 col-md-1 col-xl-auto px-md-0 mt-3">
                            </div>
                            <div class="col-12 col-md-4 col-xl-auto mt-3">
                                <label style="display:none" id="datepicker2-error" class="error" for="datepicker2">{{trans('custom.end_date_must_be_greater_than_start_date')}}</label>
                    ...
                    <div id="menu1" class="tab-pane">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-auto col-xl-auto ml-md-auto mt-3 text-center">
                                <a href="#" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="node_filter">{{trans('custom.Filter')}}</a>
                                <a href="#" onclick="resetFormNode()" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="node_filter_clear">{{trans('custom.Clear')}}</a>
                                <button class="btn bg-warning text-white py-3 px-4 rounded-sm">{{trans('custom.EXPORT')}} <img
                                        src="{{ asset('assets/images/assets/Staking_Pools/Group179.png') }}"
                                        class="img-fluid ml-3 d-inline align-middle" alt=""></button>
                            </div>
                    ...
                    <div id="menu2" class="tab-pane">
                        ...
                        <div class="row align-items-center justify-content-center">
                          ...
                          <div class="col-12 col-md-auto col-xl-auto ml-md-auto mt-3 text-center">
                                <a href="#" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="referral_filter">{{trans('custom.Filter')}}</a>
                                <a href="#" onclick="resetFormReferral()" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="referral_filter_clear">{{trans('custom.Clear')}}</a>
                                <button class="btn bg-warning text-white py-3 px-4 rounded-sm">{{trans('custom.EXPORT')}} <img
                                      src="{{ asset('assets/images/assets/Staking_Pools/Group179.png') }}"
                                      class="img-fluid ml-3 d-inline align-middle" alt=""></button>
                          </div>
                    ...
                    <div id="menu3" class="tab-pane">
                        ...
                        <div class="col-12 col-md-auto col-xl-auto ml-md-auto mt-3 text-center">
                            <a href="#" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="roi_filter">{{trans('custom.Filter')}}</a>
                                <a href="#" onclick="resetFormROI()" class="btn bg-warning text-white py-3 px-4 rounded-sm" id="roi_filter_clear">{{trans('custom.Clear')}}</a>
                            <button class="btn bg-warning text-white py-3 px-4 rounded-sm">{{trans('custom.EXPORT')}} <img
                                    src="{{ asset('assets/images/assets/Staking_Pools/Group179.png') }}"
                                    class="img-fluid ml-3 d-inline align-middle" alt=""></button>
                        </div>
