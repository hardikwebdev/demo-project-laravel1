            ...
            <div class="modal-body">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6">
                        <img src="{{ asset($product->image) }}" class="img-fluid rounded-top"
                            alt="">
                    </div>
                            ...
                            <div class="row justfy-content-between align-items-center mt-4">
                                <div class="col-12 col-xl-6 pr-xl-0">
                                    <input type="number" class="py-3 form-control grey-ph h-auto py-4"
                                        placeholder="{{trans('custom.amount')}}" name="sale_amount" id="sale_amount" value="{{ $nftpurchasehistory->amount }}">
                                ...
                                <div class="col-12 col-xl-6 mt-4 mt-xl-0">
                                    <input type="password" class="py-3 form-control grey-ph h-auto py-4"
                                        placeholder="{{trans('custom.security_password')}}" name="secure_password" id="secure_password">
                                    <span class="error-text" id="secure_password_err" style="color: red;"></span>
                                </div>
                                <div class="col-12 col-xl-6 mt-4">
                                    <button type="submit" class="btn bg-warning text-white p-4 px-5 rounded-0">{{trans('custom.SELL_NOW')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
