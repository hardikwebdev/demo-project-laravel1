                      ...
                      <div class="row align-items-center">
                        <div class="col-12 col-xl-4">
                          <div class="row align-iems-center justify-content-between">
                            ...
                            <div class="col-12 col-md-6">
                              <h4 class="text-black mb-0 font-weight-bold">@if (!empty($user->nft_wallet_address))
              ...
              <div class="tab-content border-0">
                ...
                <div id="menu1" class="tab-pane">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mt-4">
                      <button class="btn bg-warning text-white py-4 px-5 rounded-0">{{trans('custom.UPDATE_ACCOUNT')}} <img src="{{ asset('assets/images/assets/Staking_Pools/Group179.png') }}" class="img-fluid ml-4 d-inline align-middle" alt=""></button>
                    </div>
                  </div>
                  {!! Form::close() !!}
                </div>
