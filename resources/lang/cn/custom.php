...
return [
    ...
    */
    ...
    'sponsor_user_not_found_not__valid_sponsor' => '未找到该推荐人用户或不是有效的推荐人用户。请输入另一个推荐人用户名.',
    ...
    'risk_disclosure_statement' => '风险披露声明',
    'POA' => 'POA', 
    ...
    'bank_account_country' => '银行账户国家',
    'select_bank_account_country' => '选择银行账户国家',
    'state' => '州',
    ...
    'read' => '已读',
    'replay' => '回复',
    'ticket_not_found'=> '未找到单',
    'view' => '查看',
    'ticket_submit' => '单已创建成功.',
    ...
    'verify_entered_sponsor' => '请验证您输入的推荐人信息.',
    'consists_letters_numbers_underscores_only' => '此字段仅包含字母、数字和下划线.',
    'consists_letters_numbers_only' => '此字段仅包含字母和数字.',
    'consists_letters_numbers_only_api' => '身份证号码字段仅由字母和数字组成.',
    'enter_captach_valid' =>'Please enter valid captcha code', 
    'amount_must_greater_0' => '金额必须大于0',
    'enter_username' => '请输入用户名',
    'value_must_multiple_100' => '值必须是100的倍数',
    'value_must_multiple_50' => '值必须是50的倍数',
    'file_size_less_than' => '文件大小必须小于 ',
    'please_enter_password' => '请输入密码',
    'please_enter_captcha_code' => 'Please enter captcha code',
    'please_enter_least_1_characters' => '请输入至少1个字符',
    'please_enter_least_3_characters' => '请输入至少3个字符',
    'please_enter_least_10_characters' => '请输入至少10个字符',
    'please_enter_least_8_characters' => '请输入至少8个字符',
    'please_enter_no_more_than_6' => '请输入不超过6个字符',
    'please_enter_no_more_than_15' => '请输入不超过15个字符',
    'please_enter_no_more_than_50' => '请输入不超过50个字符',
    'please_enter_no_more_than_100' => '请输入不超过100个字符',
    'please_enter_no_more_than_20' => '请输入不超过12个字符',
    
    'please_check_sponsor_username_not_valid' => '请检查推荐人用户名是否无效',
    'please_select_atleast_4_checkboxes' => '必须勾选所有清单才能完成注册',
    'please_enter_sponsor_name' => '请输入推荐人名',
    'username_required_field' => '用户名是必填字段',
    'username_already_exists' => '此用户名已存在',
    'address_required_field' => '地址是必填字段',
    'city_required_field' => '城市是必填字段',
    'state_required_field' => '州是必填字段',
    'country_required_field' => '国家是必填字段',
    'ic_required_field' => '身份证是必填字段',
    'email_already_exists' => '此邮箱已存在',
    'please_enter_valid_email_address' => '请输入有效的邮箱',
    'eamil_required_field' => '邮箱是必填字段',
    'please_enter_same_value' => '请重新输入相同数值',
    
    'phone_number_required_field' => '电话是必填字段',
    'enter_valid_number' => '请输入有效的号码',
    'password_required_field' => '密码是必填字段',
    'repeatpassword_required_field' => '重复密码是必填字段',
    'securepassword_required_field' => '安全密码是必填字段',
    'repeatsecurepassword_required_field' => '重复安全密码是必填字段',
    'bankname_required_field' => '银行名称是必填字段',
    'account_holder_name_and_full_name_same' => '银行账户持有人姓名和全名必须相同',
    'accountholder_required_field' => '银行帐户持有人是必填字段',
    'accountnumber_required_field' => '银行帐号是必填字段',
    'swift_code_required_field' => '银行国际代码是必填字段',
    'bank_branch_required_field' => '银行分行是必填字段',
    'bank_country_required_field' => '银行账户国家是必填字段',
    'signature_required_field' => '签名是必填字段',
    'select_all' => '请选择全部',
    'select_bank_country' => '请选择银行帐户所在国家',
...
//Help and FAQ 
    ...
    'usdtproof_required' => 'USDT证明是必填字段',     
    ...
    'usdt_trc' => 'UDT(TRC-20)',
    'type_of_payment_address' => '付款地址类型',
